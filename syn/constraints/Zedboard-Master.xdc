...
# JA Pmod - Bank 13 
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y11  [get_ports {JA[1]}];  # "JA1"
set_property PACKAGE_PIN AA11 [get_ports {JA[2]}];  # "JA2"
set_property PACKAGE_PIN Y10  [get_ports {JA[3]}];  # "JA3"
set_property PACKAGE_PIN AA9  [get_ports {JA[4]}];  # "JA4"
set_property PACKAGE_PIN AB11 [get_ports {JA[7]}];  # "JA7"
set_property PACKAGE_PIN AB10 [get_ports {JA[8]}];  # "JA8"
set_property PACKAGE_PIN AB9  [get_ports {JA[9]}];  # "JA9"
set_property PACKAGE_PIN AA8  [get_ports {JA[10]}];  # "JA10"


# ----------------------------------------------------------------------------
# JB Pmod - Bank 13
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN W12 [get_ports {JB[1]}];  # "JB1"
set_property PACKAGE_PIN W11 [get_ports {JB[2]}];  # "JB2"
set_property PACKAGE_PIN V10 [get_ports {JB[3]}];  # "JB3"
set_property PACKAGE_PIN W8  [get_ports {JB[4]}];  # "JB4"
set_property PACKAGE_PIN V12 [get_ports {JB[7]}];  # "JB7"
set_property PACKAGE_PIN W10 [get_ports {JB[8]}];  # "JB8"
set_property PACKAGE_PIN V9  [get_ports {JB[9]}];  # "JB9"
set_property PACKAGE_PIN V8  [get_ports {JB[10]}];  # "JB10"
...
# User LEDs - Bank 33
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN T22 [get_ports {fled[0]}];  # "LD0"
set_property PACKAGE_PIN T21 [get_ports {fled[1]}];  # "LD1"
set_property PACKAGE_PIN U22 [get_ports {fled[2]}];  # "LD2"
set_property PACKAGE_PIN U21 [get_ports {fled[3]}];  # "LD3"
set_property PACKAGE_PIN V22 [get_ports {fled[4]}];  # "LD4"
set_property PACKAGE_PIN W22 [get_ports {fled[5]}];  # "LD5"
set_property PACKAGE_PIN U19 [get_ports {fled[6]}];  # "LD6"
set_property PACKAGE_PIN U14 [get_ports {fled[7]}];  # "LD7"
